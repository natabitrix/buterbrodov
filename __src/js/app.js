...
// productDetailSlider[0].controller.control = productDetailSliderThumbs;
// productDetailSliderThumbs[0].controller.control = productDetailSlider;
...
//   scrollRef <= 10 ? scrollRef++ : AOS.refreshHard();
...
//     var cow_recipie_hs = $('.home-section__recepie .decor-left');
//     var cow_recipie = $('.animations__cow_recipie');

//     if(cow_recipie_hs.hasClass("hs-inview")) {
//         setTimeout(() => {
//             cow_recipie.addClass('stop-leg');
//         }, 2000)

//     }
//     else {
//         cow_recipie.removeClass('stop-leg');

//     }

// });

// scrollAnimate.on('hs:complete', () => {
//     var cow3 = $('.home-section__recepie .decor-left');
//     cow3.addClass('complete');
...
// import Sticky from './ext/sticky.js';
...
$(document).on("ready", function () {
    ...
    $('.menu_open').on("click", function () {
        ...
        $('.header').fadeIn(300, function () {
            // Animation complete.
            // $('.animations__cow').addClass('animations');
        });
        // setTimeout(function() { 
    ...
    $('.menu_close').on("click", function () {
        ...
        $('.header').fadeOut(300, function () {
            // Animation complete.
            // $('.animations__cow').removeClass('animations');
        });
    });
    ...
    //         $('.sticky__inner').addClass('scroll_on_footer');
    //     } else {
    //         $('.sticky__inner').removeClass('scroll_on_footer');
    //     }
    // });
    ...
    $(".parallax").on("scroll", function () {
        ...
        // $('.main_slider .animations__decor').css({'position':'relative-','bottom':-$(this).scrollTop()})
